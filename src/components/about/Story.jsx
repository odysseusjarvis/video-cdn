    ...
    <section className="py-12">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <ScrollReveal direction="left">
          <span className="text-text-primary text-sm font-semibold uppercase tracking-[0.2em] mb-4 block">
            Naša Priča
          </span>
        ...
        <ScrollReveal direction="right">
          <div className="relative rounded-3xl overflow-hidden aspect-[4/3] bg-bg-secondary border border-border">
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="text-center">
                <Wrench className="text-metal-light mx-auto mb-4" size={80} />
                <p className="text-text-secondary text-sm">Autoelektrika E-Drive</p>
